    ...
    return (
        <div className="section-content" id="section-content-home">
            ...
            <div className="textContainer">
                ...
                <p>
                    I am a passionate web and mobile developer as well as a recent graduate from the University of North Texas. In my free time I like to go outdoors, cook, and gain overall inspiration for my work.
                </p>
                <p>
                    In my portfolio I've listed some of my projects, highlighting my experience. Furthermore, I'm always only a call away!
                </p>
                <a href="#section-content-projects"><img className="button" alt="arrow button" src={arrow}></img></a>
            </div>
        </div>
    )
}
